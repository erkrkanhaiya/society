...
export default function Tile(props) {
  ...
  const mediaComponent = useMemo(() => {
    return (
      <DailyMediaView
        ...
        zOrder={props.type === props.type.Thumbnail ? 1 : 0}
        style={styles.media}
        objectFit="cover"
      />
    )
  ...
  switch (props.type) {
    case 'Half':
      ...
      console.log('🚀 ~ file2222: Tile.js', props.type)
      break

    case 'Full':
      console.log('🚀 ~ file: Tile.js', props.type)
  ...
  console.log(
    '🚀 ~ file: Tile.js ~ line 161 ~ Tile ~ typeSpecificStyle',
    typeSpecificStyle,
    props.type,
  )
