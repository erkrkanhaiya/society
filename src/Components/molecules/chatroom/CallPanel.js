...
const CallPanel = props => {
  ...
  console.log('scdfvdc', thumbnailTiles)
  ...
  return (
    <>
      <View style={[styles.mainContainer, styles.largeTilesContainerOuter]}>
        {message ? null : (
          <View
          ...
          >
            ...
            >
              {props.showTherapistVideo ? largeTiles : thumbnailTiles}
            </View>
          </View>
        )}
      </View>
      <View
      // style={[styles.mainContainer, styles.largeTilesContainerOuter]}
      // style={[
