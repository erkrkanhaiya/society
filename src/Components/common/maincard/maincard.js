...
import { styles, Viewmenu } from './maincardcss'
import {
  PngIcon,
  PngIcon2,
  SvgIcon,
  ...
  return (
    <View style={styles.newlistingparent}>
      <View style={styles.newlisting}>
        ...
        <Image source={props?.image} style={{ height: 140, width: 225 }} />
      ...
      {props.verified &&  <View
        ...
        <View style={styles.profilechild2}>
          <View style={styles.view1parent}>
            <SvgIcon name={'user'} width={'40px'} height={'40px'} />
